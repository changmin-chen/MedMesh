...
function findWasmBinary() {
  return locateFile('med_mesh.wasm');
}
...
// Begin JS library code
  ...
  var _glGetBufferPointerv = _emscripten_glGetBufferPointerv;
  ...
  var _vtkStartEventLoopAsync = (callback, unRegisterInteractor, interactorRef) => {
...
var wasmImports = {
  ...
  /** @export */
  vtkStartEventLoopAsync: _vtkStartEventLoopAsync
};
